  ...
  return (
    <section className="bg-amber-500">
      <div className="container-page flex flex-col items-center gap-6 py-16 text-center sm:py-20">
        <h2 className="max-w-2xl text-3xl font-extrabold text-navy-950 sm:text-4xl">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 rounded-full border border-navy-950/20 px-6 py-3 text-sm font-semibold text-navy-950 hover:bg-navy-950/10"
          >
            {site.phone}
          </a>
        </div>
